...
checkm_stdout_path = '/home/rmclaughlin/Ryan/SAG-plus/CAMI_I_HIGH/sag_redux/51_51/2/checkM/checkM_stdout.tsv'
err_stats_path = '/home/rmclaughlin/Ryan/SAG-plus/CAMI_I_HIGH/sag_redux/51_51/2/error_analysis/All_stats.tsv'
...
merge_df.to_csv('/home/rmclaughlin/Ryan/SAG-plus/CAMI_I_HIGH/sag_redux/51_51/2/error_analysis/' +
...
combined_df = merge_df.loc[(merge_df['algorithm'] == 'combined') &
							(merge_df['level'] == 'genus')
							]
sns.set_context("paper")
ax = sns.jointplot(x='Completeness', y='sensitivity', data=combined_df,
					kind="reg", stat_func=r2
					)
plt.savefig('/home/rmclaughlin/Ryan/SAG-plus/CAMI_I_HIGH/sag_redux/51_51/2/error_analysis/' +
...
#combined_contam_compl_df = merge_contam_compl_df.loc[
#							(merge_contam_compl_df['algorithm'] == 'combined') &
#							(merge_contam_compl_df['level'] == 'genus')
#							]
#checkm_con_com_df = combined_contam_compl_df.loc[combined_contam_compl_df['assessment_type'] == 'checkM']
#true_con_com_df = combined_contam_compl_df.loc[combined_contam_compl_df['assessment_type'] == 'true']
...
plt.savefig('/home/rmclaughlin/Ryan/SAG-plus/CAMI_I_HIGH/sag_redux/51_51/2/error_analysis/' +
			'Compl_v_Conta_scatter_checkm.svg',
			bbox_inches='tight'
			)
plt.clf()
...
ax.ax_joint.plot([0.0, 100.0], [50.0, 50.0], ':k')
plt.savefig('/home/rmclaughlin/Ryan/SAG-plus/CAMI_I_HIGH/sag_redux/51_51/2/error_analysis/' +
			'Sensi_v_Precis_scatter_true.svg',
			bbox_inches='tight'
			)
plt.clf()
